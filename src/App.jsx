...
function App() {
  ...
  return (
    <section className='container mt-5'>
            ...
            <div key={product.id} className='col-md-4'>
              <div className='card' onClick={() => openModal(product)}>
                ...
                <div className="card-body">
                  ...
                  <p className='mb-0 text-ignore'>
                    { product.description }
                  </p>
                </div>
                <div className="card-footer">
                  <p className='text-end mb-0'>原價：<del>{ product.origin_price }</del> 元</p>
                  <p className='text-end mb-0'>售價：{ product.price } 元</p>
                </div>
              </div>
            </div>
          )
      ...
      <ProductModal tempProduct={tempProduct} closeModal={closeModal} />
    </section>
  )
}
